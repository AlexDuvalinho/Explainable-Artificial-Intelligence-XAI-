...
# 11 missing values for the Total charges column
...
telcom["TotalCharges"] = telcom["TotalCharges"int].astype(float)
...
# Modify Senior Citizen binary dummy variable. Want Yes or No instead of 0,1. 
telcom["SeniorCitizen"] = telcom["SeniorCitizen"].replace({1:"Yes",0:"No"})


#Add new variable: tenure to categorical column, sorted by year. Only for visualization purposes. 
...
# Confirmation via graphical visualization of potential outlliers
...
###### Distribution of each covariate for each value of churn. 
...
# Very important plots, great to understand how each predictor is distirbuted with respect to the churn output. 
# Provides a good intuition of which variables might be important and how they affect the probability of churn in general. 




##### Relation bewteen the three continuous variables and churn
